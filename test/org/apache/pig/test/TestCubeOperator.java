...
public class TestCubeOperator {
    ...
    public void setUp() throws Exception {
        ...
        data.set("input1", tuple("u1,men,green,mango"), tuple("u2,men,red,mango"), tuple("u3,men,green,apple"),
                tuple("u4,women,red,mango"), tuple("u6,women,green,mango"), tuple("u7,men,red,apple"),
                tuple("u8,men,green,mango"), tuple("u9,women,red,apple"), tuple("u10,women,green,apple"),
                tuple("u11,men,red,apple"), tuple("u12,women,green,mango"));
    ...
    public void testCubeBasic() throws IOException {
        ...
        Set<Tuple> expected = ImmutableSet.of(tf.newTuple(Lists.newArrayList("cat", "miami", (long) 1, (long) 18)),
    ...
    public void testCubeAndRollup() throws IOException {
        ...
        Set<Tuple> expected = ImmutableSet.of(
                tf.newTuple(Lists.newArrayList("dog", "miami", "white", "pet", (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList("dog", null, "white", "pet", (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList(null, "miami", "white", "pet", (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList(null, null, "white", "pet", (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList("dog", "miami", "white", null, (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList("dog", null, "white", null, (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList(null, "miami", "white", null, (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList(null, null, "white", null, (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList("dog", "miami", null, null, (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList("dog", null, null, null, (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList(null, "miami", null, null, (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList(null, null, null, null, (long) 1, (long) 5)));
    ...
    public void testCubeAfterLimit() throws IOException {
        ...
        String query = "a = load 'input' USING mock.Storage() as (x:chararray,y:chararray,z:long);" + "b = limit a 2;"
                + "c = cube b by cube(x,y);" + "d = foreach c generate flatten(group) as (x,y), SUM(cube.z) as total;"
                + "store d into 'output' using mock.Storage();";

        Util.registerMultiLineQuery(pigServer, query);

        Set<Tuple> expected = ImmutableSet.of(tf.newTuple(Lists.newArrayList("cat", "miami", (long) 18)),
    ...
    public void testCubeWithStar() throws IOException {
        ...
        String query = "a = load 'input' USING mock.Storage() as (x:chararray,y:chararray);"
                + "b = foreach a generate x as type,y as location;" + "c = cube b by cube(*);"
                + "d = foreach c generate flatten(group) as (type,location), COUNT_STAR(cube) as count;"
                + "store d into 'output' using mock.Storage();";

        Util.registerMultiLineQuery(pigServer, query);

        Set<Tuple> expected = ImmutableSet.of(tf.newTuple(Lists.newArrayList("cat", "miami", (long) 1)),
    ...
    public void testCubeDuplicateDimensions() throws IOException {
        ...
        String query = "a = load 'input' USING mock.Storage() as (x:chararray,y:chararray,z:long);"
                + "b = foreach a generate x as type,y as location, z as number;" + "c = cube b by cube($0..$1,$0..$1);"
    ...
    public void testCubeAfterFilter() throws IOException {
        ...
        String query = "a = load 'input' USING mock.Storage() as (x:chararray,y:chararray,z:long);"
                + "b = filter a by x == 'dog';" + "c = cube b by cube(x,y);"
        ...
        Set<Tuple> expected = ImmutableSet.of(tf.newTuple(Lists.newArrayList("dog", "miami", (long) 1, (long) 12)),
                tf.newTuple(Lists.newArrayList("dog", "tampa", (long) 1, (long) 14)),
                tf.newTuple(Lists.newArrayList("dog", "naples", (long) 1, (long) 5)),
                tf.newTuple(Lists.newArrayList("dog", null, (long) 3, (long) 31)),
    ...
    public void testCubeAfterOrder() throws IOException {
        ...
        String query = "a = load 'input' USING mock.Storage() as (x:chararray,y:chararray,z:long);"
                + "b = order a by $2;" + "c = cube b by cube(x,y);"
                + "d = foreach c generate flatten(group), COUNT_STAR(cube) as count, SUM(cube.z) as total;"
                + "store d into 'output' using mock.Storage();";
    ...
    public void testCubeAfterJoin() throws IOException {
        ...
        String query = "a = load 'input1' USING mock.Storage() as (a1:chararray,b1,c1,d1); "
                ...
                + "c = join a by a1, b by d2;" + "d = cube c by cube($4,$5);"
    ...
    public void testCubeAfterCogroup() throws IOException {
        ...
        String query = "a = load 'input1' USING mock.Storage() as (a1:chararray,b1,c1,d1); "
                + "b = load 'input' USING mock.Storage() as (a2,b2,c2:long,d2:chararray);"
                + "c = cogroup a by a1, b by d2;" + "d = foreach c generate flatten(a), flatten(b);"
    ...
    public void testCubeWithNULLs() throws IOException {
        ...
        Set<Tuple> expected = ImmutableSet.of(tf.newTuple(Lists.newArrayList("dog", "miami", (long) 12)),
                tf.newTuple(Lists.newArrayList("dog", null, (long) 12)),
                tf.newTuple(Lists.newArrayList(null, "miami", (long) 30)),
                tf.newTuple(Lists.newArrayList(null, null, (long) 30)),
    ...
    public void testCubeWithNULLAndFilter() throws IOException {
        ...
        String query = "a = load 'input3' USING mock.Storage() as (x:chararray,y:chararray,z:long);"
                + "b = cube a by cube(x,y);"
                + "c = foreach b generate flatten(group) as (type,location), SUM(cube.z) as total;"
                + "d = filter c by type!='unknown';" + "store d into 'output' using mock.Storage();";
    ...
    public void testExplainHolisticCubeCountDistinct() throws IOException {
        ...
        String query = "a = load 'input3' USING mock.Storage() as (a1:chararray,b1:chararray,c1:long); "
                + "b = cube a by cube(a1,b1);" + "c = foreach b {dist = distinct cube.c1; "
        ...
        try {
            ...
            for (Map.Entry<OperatorKey, PhysicalOperator> entry : kop.entrySet()) {
                ...
                if (oper instanceof POCube) {
                    ...
                    assertTrue("Expected: count_distinct Got: " + measure,
                            POCube.HOLISTIC_COUNT_DISTINCT.equals(measure));
    ...
    @Test
    public void testExplainHolisticMultipleCubeOper() throws IOException {
        // test for explain
        String query = "inp1 = load 'input3' USING mock.Storage() as (a1:chararray,b1:chararray,c1:long); "
                + "cube1 = cube inp1 by cube(a1,b1);" + "out1 = foreach cube1 {dist = distinct cube.c1; "
                + "generate flatten (group), COUNT_STAR(dist) as unique;};" + "cube2 = cube out1 by cube(a1,b1);";
